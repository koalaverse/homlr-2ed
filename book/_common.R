...
status <- function(type) {
  ...
  cat(paste0(
    ...
    ":::: status\n",
    "::: callout-", class, " \n",
    "You are reading the work-in-progress second edition of Hand-On Machine Learning with R. ",
    "This chapter ", status, ". ",
    "You can find the complete first edition at <https://bradleyboehmke.github.io/HOML/>.\n",
    ":::\n",
    "::::\n"
  ))
}